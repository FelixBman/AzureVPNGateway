...
az network local-gateway create --gateway-ip-address $REMOTE_GW_IP --name azure-to-prisma --resource-group $RG --local-address-prefixes 172.19.0.0/16 10.177.10.0/24 100.127.0.0/16  --tags $TAGS
